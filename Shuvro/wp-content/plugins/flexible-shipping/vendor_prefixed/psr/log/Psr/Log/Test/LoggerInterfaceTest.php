 ...
 */
abstract class LoggerInterfaceTest extends \FSVendor\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testContextCanContainAnything()
    {
        ...
        \fclose($closed);
        $context = array('bool' => \true, 'null' => null, 'string' => 'Foo', 'int' => 0, 'float' => 0.5, 'nested' => array('with object' => new \FSVendor\Psr\Log\Test\DummyTest()), 'object' => new \DateTime(), 'resource' => \fopen('php://memory', 'r'), 'closed' => $closed);
